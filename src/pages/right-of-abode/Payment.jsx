...
export function Payment() {
  ...
  const { request, price, setPaid } = useRightOfAbodeFlow()
  const copy = GHANA_RIGHT_OF_ABODE_FLOW.steps.payment
  ...
  const handleSubmit = (event) => {
    ...
    setPaid(true)
    navigate('/ghana/right-of-abode-guidance/confirmation')
  }
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={GHANA_RIGHT_OF_ABODE_FLOW.stepLabels} current={3} />}
      />
              ...
              <Reveal className="overflow-hidden rounded-2xl border border-border bg-card">
                ...
                <dl className="space-y-2.5 p-5 sm:p-6">
                  <div className="flex justify-between gap-4 text-sm">
                    ...
                    <dd className="font-semibold text-primary">Right of Abode Guidance</dd>
                  </div>
                  <div className="flex justify-between gap-4 text-sm">
