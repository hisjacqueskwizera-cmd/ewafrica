...
export function Confirmation() {
  useEffect(() => {
    document.title = 'Request Received | East-West Africa Link'
  }, [])

  const navigate = useNavigate()
  const { request, price, paid, resetRequest } = usePersonalizedRelocationFlow()
  const copy = GHANA_PERSONALIZED_RELOCATION_FLOW.steps.confirmation
  ...
  useEffect(() => {
    if (!paid) navigate('/ghana/personalized-relocation-guidance', { replace: true })
  }, [paid, navigate])
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={F.stepLabels} current={4} />}
      />
              ...
              <InfoBox icon={FileText} title="Your Request">
                <dl className="space-y-2">
                  <div className="flex justify-between border-b border-border pb-2">
                    ...
                    <dd>Personalized Relocation Guidance</dd>
                  </div>
                  <div className="flex justify-between border-b border-border pb-2">
