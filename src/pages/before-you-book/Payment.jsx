...
export function Payment() {
  ...
  const { request, price, setPaid } = useBeforeYouBookFlow()
  const copy = BEFORE_YOU_BOOK_FLOW.steps.payment
  ...
  const handleSubmit = (event) => {
    ...
    setPaid(true)
    navigate('/travel-planner/before-you-book-check/confirmation')
  }
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={BEFORE_YOU_BOOK_FLOW.stepLabels} current={3} />}
      />
              ...
              <Reveal className="overflow-hidden rounded-2xl border border-border bg-card">
                ...
                <dl className="space-y-2.5 p-5 sm:p-6">
                  <div className="flex justify-between gap-4 text-sm">
                    ...
                    <dd className="font-semibold text-primary">Before You Book Check</dd>
                  </div>
                  <div className="flex justify-between gap-4 text-sm">
