...
export function Confirmation() {
  ...
  const { request, price, paid, resetRequest } = useTravelAuditFlow()
  const copy = TRAVEL_AUDIT_FLOW.steps.confirmation
  ...
  useEffect(() => {
    if (!paid) navigate('/travel-planner/travel-audit', { replace: true })
  }, [paid, navigate])
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={TRAVEL_AUDIT_FLOW.stepLabels} current={4} />}
      />
