        ...
        return (
          <div key={item.label} className="border-b border-border last:border-b-0">
            <button
              ...
              className="flex w-full items-center justify-between gap-3 py-4 text-left text-sm font-bold text-primary sm:text-base"
            >
            ...
            >
              <div className="overflow-hidden">
                <p className="pb-4 pl-12 text-sm leading-relaxed text-muted-foreground">
                  {item.text}
                </p>
              </div>
            </div>
