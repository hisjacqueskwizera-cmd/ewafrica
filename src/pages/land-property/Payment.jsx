...
export function Payment() {
  ...
  const { request, price, setPaid } = useLandPropertyFlow()
  const copy = GHANA_LAND_PROPERTY_FLOW.steps.payment
  ...
  const handleSubmit = (event) => {
    ...
    setPaid(true)
    navigate('/ghana/land-property-guidance/confirmation')
  }
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={GHANA_LAND_PROPERTY_FLOW.stepLabels} current={3} />}
      />
              ...
              <Reveal className="overflow-hidden rounded-2xl border border-border bg-card">
                ...
                <dl className="space-y-2.5 p-5 sm:p-6">
                  <div className="flex justify-between gap-4 text-sm">
                    ...
                    <dd className="font-semibold text-primary">Land & Property Guidance</dd>
                  </div>
                  <div className="flex justify-between gap-4 text-sm">
