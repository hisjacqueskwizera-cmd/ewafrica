...
export function Confirmation() {
  ...
  const { request, price, isCustomQuote, paid, resetRequest } = useBorderCrossingFlow()
  const copy = BORDER_CROSSING_FLOW.steps.confirmation
  ...
  useEffect(() => {
    if (!paid) navigate('/travel-planner/border-crossing-guide', { replace: true })
  }, [paid, navigate])
  ...
  const amountLabel = isCustomQuote ? 'Custom Quote — pending review' : `$${price ?? '—'} USD`
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={BORDER_CROSSING_FLOW.stepLabels} current={4} />}
      />
              ...
              <InfoBox icon={FileText} title="Your Request">
                <dl className="space-y-2">
                  <div className="flex justify-between border-b border-border pb-2">
                    ...
                    <dd>Border Crossing Guide</dd>
                  </div>
                  <div className="flex justify-between border-b border-border pb-2">
                    <dt className="font-semibold text-primary">Route:</dt>
                    <dd>{route || 'Not provided'}</dd>
                  </div>
                  <div className="flex justify-between border-b border-border pb-2">
                    <dt className="font-semibold text-primary">Amount:</dt>
                    <dd>{amountLabel}</dd>
                  </div>
