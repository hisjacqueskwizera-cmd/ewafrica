...
export function Confirmation() {
  ...
  const { request, price, paid, resetRequest } = useRightOfAbodeFlow()
  const copy = GHANA_RIGHT_OF_ABODE_FLOW.steps.confirmation
  ...
  useEffect(() => {
    if (!paid) navigate('/ghana/right-of-abode-guidance', { replace: true })
  }, [paid, navigate])
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={GHANA_RIGHT_OF_ABODE_FLOW.stepLabels} current={4} />}
      />
