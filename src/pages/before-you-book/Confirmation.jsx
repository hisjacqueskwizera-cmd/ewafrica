...
export function Confirmation() {
  ...
  const { request, price, paid, resetRequest } = useBeforeYouBookFlow()
  const copy = BEFORE_YOU_BOOK_FLOW.steps.confirmation
  ...
  useEffect(() => {
    if (!paid) navigate('/travel-planner/before-you-book-check', { replace: true })
  }, [paid, navigate])
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={BEFORE_YOU_BOOK_FLOW.stepLabels} current={4} />}
      />
              ...
              <InfoBox icon={FileText} title="Your Request">
                <dl className="space-y-2">
                  <div className="flex justify-between border-b border-border pb-2">
                    ...
                    <dd>Before You Book Check</dd>
                  </div>
                  <div className="flex justify-between border-b border-border pb-2">
                    <dt className="font-semibold text-primary">Destinations:</dt>
