...
export function Confirmation() {
  ...
  const { request, price, paid, resetRequest } = useLandPropertyFlow()
  const copy = GHANA_LAND_PROPERTY_FLOW.steps.confirmation
  ...
  useEffect(() => {
    if (!paid) navigate('/ghana/land-property-guidance', { replace: true })
  }, [paid, navigate])
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={GHANA_LAND_PROPERTY_FLOW.stepLabels} current={4} />}
      />
