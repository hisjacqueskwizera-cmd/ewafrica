...
export function Confirmation() {
  ...
  const { request, price, paid, resetRequest } = useRelocationFlow()
  const copy = GHANA_RELOCATION_FLOW.steps.confirmation
  ...
  useEffect(() => {
    if (!paid) navigate('/ghana/complete-relocation-package', { replace: true })
  }, [paid, navigate])
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={GHANA_RELOCATION_FLOW.stepLabels} current={4} />}
      />
              ...
              <InfoBox icon={FileText} title="Your Request">
                <dl className="space-y-2">
                  <div className="flex justify-between border-b border-border pb-2">
                    ...
                    <dd>Complete Relocation Package</dd>
                  </div>
                  <div className="flex justify-between border-b border-border pb-2">
