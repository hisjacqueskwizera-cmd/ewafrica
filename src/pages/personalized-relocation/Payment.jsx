...
export function Payment() {
  ...
  const { request, price, setPaid } = usePersonalizedRelocationFlow()
  const copy = GHANA_PERSONALIZED_RELOCATION_FLOW.steps.payment
  ...
  const handleSubmit = (event) => {
    ...
    setPaid(true)
    navigate('/ghana/personalized-relocation-guidance/confirmation')
  }
  ...
  return (
    <>
      ...
      <PlannerStepHero
        ...
        stepper={<PlannerStepper steps={F.stepLabels} current={3} />}
      />
              ...
              <Reveal className="overflow-hidden rounded-2xl border border-border bg-card">
                ...
                <dl className="space-y-2.5 p-5 sm:p-6">
                  <div className="flex justify-between gap-4 text-sm">
                    ...
                    <dd className="font-semibold text-primary">Personalized Relocation Guidance</dd>
                  </div>
                  <div className="flex justify-between gap-4 text-sm">
                    <dt className="text-muted-foreground">Country</dt>
                    <dd className="text-right font-semibold text-primary">Ghana</dd>
                  </div>
                  <div className="flex justify-between gap-4 text-sm">
